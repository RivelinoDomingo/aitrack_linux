...
#include <memory>
#include "../../../Client/src/view/WindowMain.h"
...
QT_MOC_LITERAL(1, 11, 12), // "onTrackClick"
QT_MOC_LITERAL(2, 24, 0), // ""
QT_MOC_LITERAL(3, 25, 11), // "onSaveClick"
QT_MOC_LITERAL(4, 37, 13) // "onConfigClick"

    },
    "WindowMain\0onTrackClick\0\0onSaveClick\0"
    "onConfigClick"
};
...
void WindowMain::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->onTrackClick(); break;
        case 1: _t->onSaveClick(); break;
        case 2: _t->onConfigClick(); break;
        default: ;
        }
    }
    (void)_a;
...
void *WindowMain::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, "IRootView"))
        return static_cast< IRootView*>(this);
